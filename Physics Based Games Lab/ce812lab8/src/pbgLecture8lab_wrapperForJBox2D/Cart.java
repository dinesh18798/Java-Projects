...
public class Cart {
    ...
    public Cart(float sx, float sy, float vx, float vy, Color col, float mass, float rollingFriction, float height, float width, float radius) {
        ...
        // Cart
        cartBody = new BasicRectangle(sx,sy, 0f, 0f, Color.DARK_GRAY, 5f, rollingFriction, width, height, false);
        ...
        // Pole
        pole = new BasicRectangle(sx, (sy + height / 2f) + poleHeight / 2f, 0f, 0f, Color.RED, 0.1f, rollingFriction, poleWidth, poleHeight, false);
    ...
    public void notificationOfNewTimestep() {
        if (BasicKeyListener.isRotateLeftKeyPressed()) {
            cartBody.body.applyForce(new Vec2(-60, 0), new Vec2(0, 0));
